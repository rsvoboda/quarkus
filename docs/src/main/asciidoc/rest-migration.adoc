...
The server part of Quarkus REST (`quarkus-rest` and its dependencies) provides an implementation of the Jakarta REST specification, but leverages Quarkus' build time processing
