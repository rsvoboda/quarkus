...
Also provides an OTel collector to receive the data.
...
In this case, the traceId and spanId of one of the request that triggered the metric, since it was last sent.
