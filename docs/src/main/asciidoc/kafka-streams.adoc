...
This is done to gracefully await the creation of topics that don't yet exist at application startup time.
...
Launching multiple instances of the `aggregator` application will make the overall architecture look like so:
