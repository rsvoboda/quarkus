...
We'll be using the Quarkus Infinispan Client extension to connect to and interact with Infinispan.
...
We should be able to reload the Infinispan Server Console and display the content of the Cache.
